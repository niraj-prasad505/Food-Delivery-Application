// server/src/controllers/UserAuth.controller.js
...
const register = async (req, res) => {
  try {
    const { fullname, email, otp, password, confirmPassword } = req.body;

    if (!fullname || !email || !otp || !password || !confirmPassword) {
    ...
    await UserPreference.create({ user: newUser._id });
    await EmailOtp.deleteOne({ _id: otpRecord._id });

    // Auto-login cookie on register
